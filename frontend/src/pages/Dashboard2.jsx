    ...
    <div className="bg-red-50 min-h-screen">
      ...
      <nav className="flex justify-between items-center px-8 py-4 bg-red-700 shadow-md">
        ...
        <div className="md:hidden" onClick={() => setIsMenuOpen(!isMenuOpen)}>
          {isMenuOpen ? <FaTimes className="text-white h-6 w-6" /> : <FaBars className="text-white h-6 w-6" />}
        </div>

        {/* Navigation Links */}
        <ul className={`flex-col md:flex md:flex-row md:space-x-6 absolute md:static bg-red-700 w-full md:w-auto transition-all duration-300 ease-in-out ${isMenuOpen ? 'top-16' : 'top-[-200px]'}`}>
      ...
      {/* Main Content */}
      <div className="flex flex-col items-start px-4 md:px-16 py-16">
        ...
        {/* Cards Section */}
        <div className="flex flex-col md:flex-row space-x-0 md:space-x-20 mt-28">
          {[
            ...
            <div
              key={index}
              className="bg-white p-6 rounded-lg shadow-xl w-full md:w-52 shadow-gray-300 transition-all duration-500 ease-in-out 
              hover:shadow-red-500 hover:shadow-xl hover:animate-shake mb-4 md:mb-0"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-11 mt-32">
          {/* Row 1 */}
          <motion.div 
